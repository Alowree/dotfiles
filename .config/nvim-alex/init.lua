...
-- Auto-load all plugin configs from lua/plugin/
-- This replaces Neovim's default plugin/ auto-sourcing behavior
for _, plugin_file in ipairs(vim.fn.glob(vim.fn.stdpath("config") .. "/lua/plugin/*.lua", true, true)) do
